...
const ProfilePage = () => {
  ...
  const [profileData, setProfileData] = useState({
    name: "Akhtar Zeb Bacha",
    email: "azaib5101@gmail.com",
    phone: "+92-349-545-2856",
    location: "Madyan - 19020, Swat , Pakistan",
    role: "Frontend Developer",
    bio: "I am a dedicated Front-End developer with a strong focus on creating polished and efficient web interfaces. I am currently enhancing my expertise in ReactJS and NodeJS, working toward mastery as a MERN-Stack Developer. With an emerging interest in DevOps, I am keen to contribute my skills and collaborate on innovative web development projects."
  });
